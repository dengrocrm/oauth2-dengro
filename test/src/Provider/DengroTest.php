...
class DengroTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAuthorizationUrl()
    {
        ...
        $this->assertEquals('/oauth/auth/', $uri['path']);
    }
    ...
    public function testPhabricatorDomainUrls()
    {
        ...
        $this->assertEquals($this->domain.'/oauth/auth/', $this->provider->getBaseAuthorizationUrl());
        $this->assertEquals($this->domain.'/oauth/token/', $this->provider->getBaseAccessTokenUrl([]));
        $this->assertEquals($this->domain.'/api/details', $this->provider->getResourceOwnerDetailsUrl($token));
    }
