...
namespace Dengro\OAuth2\Client\Test\Provider;

use League\OAuth2\Client\Tool\QueryBuilderTrait;
use Mockery as m;

class DengroTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->provider = new \Dengro\OAuth2\Client\Provider\Dengro([
    ...
    public function testUserData()
    {
        ...
        $userResponse->shouldReceive('getBody')->andReturn('{"account_id": "' . $account_id . '", "name": {"given_name": "'. $name . '", "surname": "'. $name . '", "familiar_name": "'. $name . '", "display_name": "'. $name . '", "abbreviated_name": "XX"}, "email": "email@domain.com", "email_verified": true, "country": "BR", "locale": "pt-BR", "referral_link": "https://db.tt/XXXXXXX", "is_paired": false, "account_type": {".tag": "basic"}}');
